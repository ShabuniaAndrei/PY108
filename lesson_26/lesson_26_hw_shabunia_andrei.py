...
#             return cursor.execute('''INSERT INTO tab_1(col_1) VALUES (?)''', (3,))
#         elif a is not None and b is not None and c is None:
#             return cursor.execute('''DELETE FROM tab_1 WHERE id=(?)''', (1,))
#         elif a is not None and b is not None and type(c) is int:
#             return cursor.execute('''UPDATE tab_1 SET col_1=(?) WHERE id=(?)''', (77, 3,))
#
#
